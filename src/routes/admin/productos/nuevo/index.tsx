...
export default component$(() => {
  ...
  const isOffer = useSignal(false);
  const basePrice = useSignal(0);
  const discountPrice = useSignal(0);
  const discountPercent = useSignal(0);
        ...
        >
          ...
          <div class="space-y-4">
            ...
            <div class="space-y-1.5">
              ...
              <textarea id="description" name="description" rows={4} class="w-full rounded-md border border-slate-300 px-3 py-2 text-sm focus:border-cyan-500 focus:ring-cyan-500 outline-none resize-none" placeholder="Descripción detallada del producto..."></textarea>
